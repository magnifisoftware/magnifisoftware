...
MySQL - 5.6.33-0ubuntu0.14.04.1 : Database - qsonline
*********************************************************************
*/
...
CREATE TABLE `bread_standard` (
  ...
  `ferment_set_temperature_min` int(11) NOT NULL COMMENT '发酵温度最小值',
  `ferment_set_temperature_max` int(11) NOT NULL COMMENT '发酵温度最大值',
  ...
  `proofing_temperature_min` int(11) NOT NULL COMMENT '醒发设定温度最小值',
  ...
  `cooling_temperature_min` int(11) NOT NULL COMMENT '冷却前面包温度最小值',
  `cooling_temperature_max` int(11) NOT NULL COMMENT '冷却前面包温度最大值',
  `ccp3_sus` double(5,2) NOT NULL COMMENT 'SUS值'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `bread_standard` */

insert  into `bread_standard`(`first_stir_low_time`,`first_stir_high_time`,`first_stir_temperature_min`,`first_stir_temperature_max`,`ferment_set_temperature_min`,`ferment_set_temperature_max`,`ferment_humidity_min`,`ferment_humidity_max`,`ferment_time_min`,`ferment_time_max`,`ferment_bread_temperature_min`,`ferment_bread_temperature_max`,`second_stir_low_time`,`second_stir_high_time_min`,`second_stir_high_time_max`,`second_stir_temperature_min`,`second_stir_temperature_max`,`proofing_temperature_min`,`proofing_temperature_max`,`proofing_humidity_min`,`proofing_humidity_max`,`proofing_time_min`,`proofing_time_max`,`proofing_bread_temperature_min`,`proofing_bread_temperature_max`,`cut_temperature_min`,`cut_temperature_max`,`decorate_water_pressure_min`,`decorate_water_pressure_max`,`bake_set_temperature_min`,`bake_set_temperature_max`,`bake_time_min`,`bake_time_max`,`bake_center_temperature_min`,`bake_center_temperature_max`,`cooling_temperature_min`,`cooling_temperature_max`,`ccp3_sus`) values 
(1,4,23.50,24.50,27,29,70,85,3.25,4,28.90,30,1,8,12,23.50,24.50,37,38.90,86,92,55,60,35.50,36.50,27.50,28.50,0.15,0.25,240,300,7.00,13.00,93.30,96.70,35,38,2.50);
